...
<div class="max-w-2xl mx-auto">
    <x-card>
        <x-slot name="header">
            <h2 class="text-xl font-bold text-slate-800 uppercase tracking-tight">Tambah Kandidat Baru</h2>
        </x-slot>

        <form action="{{ route('kandidat.store') }}" method="POST" class="space-y-6">
            @csrf
